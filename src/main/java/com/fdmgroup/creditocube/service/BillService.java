...
public class BillService {
	...
	// If the bill has not been paid in full, an interest fee is charged on the outstanding bill amount and added to the card balance.
	public void checkLatePayment(Bill bill) {
		...
		if (bill.getOutstandingAmount() > 0) {
			...
			double interestFee = new BigDecimal(bill.getOutstandingAmount() * 0.1).setScale(2, RoundingMode.HALF_UP).doubleValue();
