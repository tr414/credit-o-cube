...
public class CustomerService {
     ...
     * Used to hash passwords before they are stored in the database, enhancing security.
     */
    @Autowired
     ...
     * The password is encoded before saving to ensure the security of user data.
     *
     ...
     * @return the newly created user, now stored in the database with an encoded password
     */
